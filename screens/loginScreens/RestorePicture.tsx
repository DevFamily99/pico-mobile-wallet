...
import { ImageURISource, StyleSheet, TouchableOpacity, PermissionsAndroid} from 'react-native'
...
export default function RestorePicture({navigation, route}: LoginStackScreenProps<'RestorePicture'>) {
